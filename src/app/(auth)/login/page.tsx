    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-amber-600 via-yellow-600 to-amber-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full px-12 text-white">
          <SparklesIcon className="w-20 h-20 mb-8 animate-bounce" strokeWidth={1.5} />
          ...
          <p className="text-xl text-yellow-100 text-center max-w-md mb-8">
            Access thousands of premium products, exclusive deals, and personalized recommendations
          </p>
          <div className="flex flex-col gap-4 text-yellow-100">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg">Free shipping on orders $50+</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-lg">Secure payment & buyer protection</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 bg-white/20 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-lg">Earn rewards on every purchase</span>
            </div>
          </div>
        </div>
      </div>
